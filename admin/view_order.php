...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center>Kshs <?php echo $rows['price']; ?></center></td>
            ...
            <!-- footer -->
            <footer class="footer"> <div class="on_footer_parallax">
		
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>iFoods</span>. All Rights Reser<p>&copy; <?php echo strftime("%Y", time()); ?> <span>iFoods</span>. All Rights Reserved</p>Template designed by <a href="https://colorlib.com">Colorlib</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
